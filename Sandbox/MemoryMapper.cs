...
namespace Sandbox
{
    public class FF1MapperRom : FF1Rom
    {
	    ...
	    public void UpgradeToMMC3()
	    {
		    ...
		    // Change bank swap code.  Writing 0x3FE03 - 0x3FE1C
			// We put this code at SwapPRG_L, so we don't have to move any of the "long" calls to it.
			// We completely overwrite SetMMC1SwapMode, since we don't need it anymore, and partially overwrite SwapPRG, since it got moved.
