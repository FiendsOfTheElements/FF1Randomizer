...
namespace FF1Lib.Assembly
{
	...
	public static class Symbols
	{
		...
		public static class Labels
		{
			...
			public static BA PaletteFrame                        = new BA(0x0F, 0xFF70);
			public static BA BackUpBatSprPalettes                = new BA(0x0F, 0xFF64);
			public static BA BrightenBatSprPalettes              = new BA(0x0F, 0xFF40);
			public static BA DimBatSprPalettes                   = new BA(0x0F, 0xFF20);
			public static BA OnIRQ                               = new BA(0x0F, 0xFEBB);
			public static BA OnNMI                               = new BA(0x0F, 0xFE9C);
			public static BA ClearBGPalette                      = new BA(0x0F, 0xFEBE);
			public static BA OnReset                             = new BA(0x0F, 0xFE2E);
			public static BA SetMMC1SwapMode                     = new BA(0x0F, 0xFE06);
			public static BA SwapPRG                             = new BA(0x0F, 0xFE1A);
			public static BA WaitForVBlank                       = new BA(0x0F, 0xFEA8);
			public static BA UNUSED_DrawBattle_IncSrcPtr         = new BA(0x0F, 0xFCBB);
			public static BA lut_CharacterNamePtr                = new BA(0x0F, 0xFCAA);
			public static BA DrawBattleSubString                 = new BA(0x0F, 0xFC94);
			public static BA DrawBattleSubString_Max8            = new BA(0x0F, 0xFC8D);
			public static BA BattleDrawLoadSubSrcPtr             = new BA(0x0F, 0xFC00);
			public static BA DrawEnemyName                       = new BA(0x0F, 0xFC7A);
			public static BA DrawEntityName                      = new BA(0x0F, 0xFC4F);
			public static BA DrawString_SpaceRun                 = new BA(0x0F, 0xFC39);
			public static BA DrawBattleMessage                   = new BA(0x0F, 0xFC26);
			public static BA DrawBattleString_Code11_Short       = new BA(0x0F, 0xFB93);
			public static BA DrawBattleString_Code0C             = new BA(0x0F, 0xFB2F);
			public static BA DrawBattle_Number                   = new BA(0x0F, 0xFB3D);
			public static BA DrawBattleString_Code11             = new BA(0x0F, 0xFB1E);
			public static BA DrawBattle_Division                 = new BA(0x0F, 0xFAFC);
			public static BA DrawBattleString_IncDstPtr          = new BA(0x0F, 0xFCC2);
			public static BA DrawBattleString_DrawChar           = new BA(0x0F, 0xFAF1);
			public static BA DrawBattle_IncSrcPtr                = new BA(0x0F, 0xFCB2);
			public static BA DrawBattleString_ExpandChar         = new BA(0x0F, 0xFAA6);
			public static BA DrawBattleString_ControlCode        = new BA(0x0F, 0xFB96);
			public static BA lut_EnemyRosterStrings              = new BA(0x0F, 0xFA51);
			public static BA lut_CombatDrinkBox                  = new BA(0x0F, 0xFA16);
			public static BA ShiftLeft5                          = new BA(0x0F, 0xF898);
			public static BA BattleMenu_DrawMagicNames           = new BA(0x0F, 0xF844);
			public static BA ShiftLeft6                          = new BA(0x0F, 0xF897);
			public static BA lut_CombatItemMagicBox              = new BA(0x0F, 0xFA11);
			public static BA ClearUnformattedCombatBoxBuffer     = new BA(0x0F, 0xF757);
			public static BA lut_CombatBoxes                     = new BA(0x0F, 0xF9E9);
			public static BA lua_BattleCommandBoxInfo            = new BA(0x0F, 0xFA1B);
			public static BA GetPointerToRosterString            = new BA(0x0F, 0xF99C);
			public static BA lut_EnemyRosterBox                  = new BA(0x0F, 0xF9E4);
			public static BA BattleDraw_AddBlockToBuffer         = new BA(0x0F, 0xF690);
			public static BA UndrawBattleBlock                   = new BA(0x0F, 0xF65A);
			public static BA DrawBlockBuffer                     = new BA(0x0F, 0xF648);
			public static BA DrawBattleString                    = new BA(0x0F, 0xF9AB);
			public static BA DrawBattleBoxAndText                = new BA(0x0F, 0xF608);
			public static BA DrawBattleBox_Exit                  = new BA(0x0F, 0xF607);
			public static BA DrawBattleBox_FetchBlock            = new BA(0x0F, 0xF5FB);
			public static BA DrawBattleBox_NextBlock             = new BA(0x0F, 0xF5ED);
			public static BA DrawBattleBox                       = new BA(0x0F, 0xF59B);
			public static BA DrawBattleBox_Row                   = new BA(0x0F, 0xF572);
			public static BA GetBattleMessagePtr                 = new BA(0x0F, 0xF544);
			public static BA BattleDrawMessageBuffer_Reverse     = new BA(0x0F, 0xF4FF);
			public static BA Battle_DrawMessageRow               = new BA(0x0F, 0xF4E8);
			public static BA Battle_DrawMessageRow_VBlank        = new BA(0x0F, 0xF4E5);
			public static BA BattleDrawMessageBuffer             = new BA(0x0F, 0xF4AA);
			public static BA BattleUpdateAudio_FixedBank         = new BA(0x0F, 0xF493);
			public static BA Battle_UpdatePPU_UpdateAudio_FixedBank = new BA(0x0F, 0xF485);
			public static BA DrawBattleBackdropRow               = new BA(0x0F, 0xF385);
			public static BA LoadBattlePalette                   = new BA(0x0F, 0xF471);
			public static BA lut_BtlAttrTbl                      = new BA(0x0F, 0xF400);
			public static BA Battle_PlayerBox                    = new BA(0x0F, 0xF3C6);
			public static BA BattleBox_vAXY                      = new BA(0x0F, 0xF3E2);
			public static BA SetPPUAddr_XA                       = new BA(0x0F, 0xF3BF);
			public static BA Battle_PPUOff                       = new BA(0x0F, 0xF3F1);
			public static BA SetBattlePPUAddr                    = new BA(0x0F, 0xF233);
			public static BA SwapBtlTmpBytes                     = new BA(0x0F, 0xFCCF);
			public static BA FormatBattleString                  = new BA(0x0F, 0xFA59);
			public static BA BattleScreenShake                   = new BA(0x0F, 0xF440);
			public static BA BattleRNG                           = new BA(0x0F, 0xFCE7);
			public static BA DrawDrinkBox                        = new BA(0x0F, 0xF921);
			public static BA DrawBattleItemBox                   = new BA(0x0F, 0xF89E);
			public static BA BattleWaitForVBlank                 = new BA(0x0F, 0xF4A1);
			public static BA DrawBattleMagicBox                  = new BA(0x0F, 0xF764);
			public static BA DrawCombatBox                       = new BA(0x0F, 0xF71C);
			public static BA DrawCommandBox                      = new BA(0x0F, 0xF700);
			public static BA DrawRosterBox                       = new BA(0x0F, 0xF6C3);
			public static BA UndrawNBattleBlocks                 = new BA(0x0F, 0xF6B3);
			public static BA ClearBattleMessageBuffer            = new BA(0x0F, 0xF620);
			public static BA BattleCrossPageJump                 = new BA(0x0F, 0xF284);
			public static BA Battle_ReadPPUData                  = new BA(0x0F, 0xF268);
			public static BA Battle_WritePPUData                 = new BA(0x0F, 0xF23E);
			public static BA EnterBattle                         = new BA(0x0F, 0xF28D);
			public static BA lutItemBoxStrPos                    = new BA(0x0F, 0xEFCC);
			public static BA ReadjustBBEquipStats                = new BA(0x0F, 0xEEDB);
			public static BA UnadjustBBEquipStats                = new BA(0x0F, 0xEEB7);
			public static BA lut_EquipStringPositions            = new BA(0x0F, 0xED72);
			public static BA lutCursor2x2SpriteTable             = new BA(0x0F, 0xECB0);
			public static BA DrawOBSprite_Exit                   = new BA(0x0F, 0xEBFC);
			public static BA Faux_LoadBattleBGPalettes           = new BA(0x0F, 0xEB93);
			public static BA LoadBattleBackdropPalette           = new BA(0x0F, 0xEB7C);
			public static BA LoadBackdropPalette                 = new BA(0x0F, 0xEB5A);
			public static BA lut_ShopTypes                       = new BA(0x0F, 0xEBB5);
			public static BA LoadBorderPalette_Black             = new BA(0x0F, 0xEB2D);
			public static BA LoadBattleSpritePalettes            = new BA(0x0F, 0xEB99);
			public static BA LoadBorderPalette_Blue              = new BA(0x0F, 0xEB29);
			public static BA LoadBattleBGPalettes                = new BA(0x0F, 0xEB8D);
			public static BA LoadBattleBGCHRPointers             = new BA(0x0F, 0xEA7A);
			public static BA lut_ShopPalettes                    = new BA(0x0F, 0xEB74);
			public static BA LoadShopTypeAndPalette              = new BA(0x0F, 0xEB42);
			public static BA CHRLoad                             = new BA(0x0F, 0xE965);
			public static BA LoadOWObjectCHR                     = new BA(0x0F, 0xE940);
			public static BA LoadOWBGCHR                         = new BA(0x0F, 0xE94B);
			public static BA LoadMapObjCHR                       = new BA(0x0F, 0xE99E);
			public static BA LoadTilesetAndMenuCHR               = new BA(0x0F, 0xE975);
			public static BA LoadPlayerMapmanCHR                 = new BA(0x0F, 0xE92E);
			public static BA LoadShopBGCHRPalettes               = new BA(0x0F, 0xEA02);
			public static BA LoadBatSprCHRPalettes               = new BA(0x0F, 0xEAE1);
			public static BA LoadBattleBGCHRAndPalettes          = new BA(0x0F, 0xEA28);
			public static BA LoadBatSprCHRPalettes_NewGame       = new BA(0x0F, 0xEAB9);
			public static BA LoadMenuBGCHRAndPalettes            = new BA(0x0F, 0xEA9F);
			public static BA LoadMenuCHR                         = new BA(0x0F, 0xE98E);
			public static BA CHRLoad_Cont                        = new BA(0x0F, 0xE967);
			public static BA CHRLoadToA                          = new BA(0x0F, 0xE95A);
			public static BA LoadSingleMapObject                 = new BA(0x0F, 0xE83B);
			public static BA lut_2x2MapObj_Right                 = new BA(0x0F, 0xE7AB);
			public static BA lut_2x2MapObj_Left                  = new BA(0x0F, 0xE7BB);
			public static BA lut_2x2MapObj_Up                    = new BA(0x0F, 0xE7CB);
			public static BA lut_2x2MapObj_Down                  = new BA(0x0F, 0xE7DB);
			public static BA CanMapObjMove                       = new BA(0x0F, 0xE630);
			public static BA DrawMapObject                       = new BA(0x0F, 0xE6D8);
			public static BA MapObjectMove                       = new BA(0x0F, 0xE50A);
			public static BA AnimateAndDrawMapObject             = new BA(0x0F, 0xE688);
			public static BA UpdateAndDrawMapObjects             = new BA(0x0F, 0xE4C7);
			public static BA ConvertOWToSprite                   = new BA(0x0F, 0xE3DF);
			public static BA DrawOWObj_Exit                      = new BA(0x0F, 0xE3A5);
			public static BA lut_PlayerMapmanSprTbl              = new BA(0x0F, 0xE427);
			public static BA lut_VehicleSprTbl                   = new BA(0x0F, 0xE467);
			public static BA Draw2x2Sprite                       = new BA(0x0F, 0xE301);
			public static BA lut_OWObjectSprTbl                  = new BA(0x0F, 0xE4A7);
			public static BA Draw2x2Vehicle_Set                  = new BA(0x0F, 0xE2E0);
			public static BA DrawMMV_Ship                        = new BA(0x0F, 0xE2D5);
			public static BA DrawMMV_Canoe                       = new BA(0x0F, 0xE2DC);
			public static BA DrawMMV_OnFoot                      = new BA(0x0F, 0xE2F0);
			public static BA lut_VehicleFacingSprTblOffset       = new BA(0x0F, 0xE417);
			public static BA lut_VehicleSprY                     = new BA(0x0F, 0xE36A);
			public static BA DrawOWObj_Airship                   = new BA(0x0F, 0xE38C);
			public static BA DrawPlayerMapmanSprite              = new BA(0x0F, 0xE281);
			public static BA DrawOWObj_BridgeCanal               = new BA(0x0F, 0xE3A6);
			public static BA DrawOWObj_Ship                      = new BA(0x0F, 0xE373);
			public static BA DrawAirshipShadow                   = new BA(0x0F, 0xE2B8);
			public static BA Draw2x2Vehicle                      = new BA(0x0F, 0xE2DE);
			public static BA AirshipTransitionFrame              = new BA(0x0F, 0xE1E1);
			public static BA DrawBoxRow_Bot                      = new BA(0x0F, 0xE0D7);
			public static BA DrawBoxRow_Mid                      = new BA(0x0F, 0xE0A5);
			public static BA DrawBoxRow_Top                      = new BA(0x0F, 0xE0FC);
			public static BA MenuCondStall                       = new BA(0x0F, 0xE12E);
			public static BA DrawComplexString_Exit              = new BA(0x0F, 0xDE29);
			public static BA lut_ArmorSlots                      = new BA(0x0F, 0xDD68);
			public static BA FindEmptyArmorSlot                  = new BA(0x0F, 0xDD46);
			public static BA lut_WeaponSlots                     = new BA(0x0F, 0xDD58);
			public static BA CoordToNTAddr                       = new BA(0x0F, 0xDCAB);
			public static BA lut_NTRowStartLo                    = new BA(0x0F, 0xDCF4);
			public static BA lut_NTRowStartHi                    = new BA(0x0F, 0xDD14);
			public static BA lut_DTE2                            = new BA(0x0F, 0xF050);
			public static BA lut_DTE1                            = new BA(0x0F, 0xF0A0);
			public static BA SetPPUAddrToDest                    = new BA(0x0F, 0xDC80);
			public static BA DrawDialogueString_Done             = new BA(0x0F, 0xDB60);
			public static BA DoAltarScanline                     = new BA(0x0F, 0xDB0B);
			public static BA WaitAltarScanline                   = new BA(0x0F, 0xDB00);
			public static BA AltarFrame                          = new BA(0x0F, 0xDADE);
			public static BA PalCyc_Step                         = new BA(0x0F, 0xD9EF);
			public static BA PalCyc_GetInitialPal                = new BA(0x0F, 0xD9B3);
			public static BA PalCyc_SetScroll                    = new BA(0x0F, 0xD982);
			public static BA PalCyc_DrawPalette                  = new BA(0x0F, 0xD918);
			public static BA WaitVBlank_NoSprites                = new BA(0x0F, 0xD89F);
			public static BA _DrawPalette_Norm                   = new BA(0x0F, 0xD880);
			public static BA ProcessJoyButtons                   = new BA(0x0F, 0xD7E2);
			public static BA ReadJoypadData                      = new BA(0x0F, 0xD7C9);
			public static BA ScreenWipeFrame_Prep                = new BA(0x0F, 0xD72F);
			public static BA ScreenWipe_Finalize                 = new BA(0x0F, 0xD723);
			public static BA ScreenWipeFrame                     = new BA(0x0F, 0xD742);
			public static BA StartScreenWipe                     = new BA(0x0F, 0xD79D);
			public static BA WaitScanline                        = new BA(0x0F, 0xD788);
			public static BA Dialogue_CoverSprites_VBl           = new BA(0x0F, 0xFF02);
			public static BA DialogueBox_Frame                   = new BA(0x0F, 0xD6A1);
			public static BA DialogueBox_Sfx                     = new BA(0x0F, 0xD6C7);
			public static BA DlgBoxPrep_DR                       = new BA(0x0F, 0xD5D0);
			public static BA DlgBoxPrep_DL                       = new BA(0x0F, 0xD5BE);
			public static BA DlgBoxPrep_UR                       = new BA(0x0F, 0xD5AC);
			public static BA DlgBoxPrep_UL                       = new BA(0x0F, 0xD59A);
			public static BA DrawDialogueString                  = new BA(0x0F, 0xDB64);
			public static BA PrepDialogueBoxAttr                 = new BA(0x0F, 0xD53E);
			public static BA PrepDialogueBoxRow                  = new BA(0x0F, 0xD549);
			public static BA PrepSMRowCol                        = new BA(0x0F, 0xD1E4);
			public static BA Map_RTS                             = new BA(0x0F, 0xD156);
			public static BA DecompressMap                       = new BA(0x0F, 0xD186);
			public static BA LoadOWMapRow                        = new BA(0x0F, 0xD157);
			public static BA PrepRowCol                          = new BA(0x0F, 0xD258);
			public static BA ScrollUpOneRow                      = new BA(0x0F, 0xD102);
			public static BA DrawMapAttributes                   = new BA(0x0F, 0xD46F);
			public static BA DrawMapRowCol                       = new BA(0x0F, 0xD2E9);
			public static BA LoadSMCHR                           = new BA(0x0F, 0xE912);
			public static BA LoadMapObjects                      = new BA(0x0F, 0xE7EB);
			public static BA LoadStandardMap                     = new BA(0x0F, 0xD126);
			public static BA AssertNasirCRC                      = new BA(0x0F, 0xCFCB);
			public static BA PrepStandardMap                     = new BA(0x0F, 0xCF55);
			public static BA LoadStandardMapAndObjects           = new BA(0x0F, 0xCF42);
			public static BA RedrawDoor_Exit                     = new BA(0x0F, 0xCEBA);
			public static BA lut_2xNTRowStartHi                  = new BA(0x0F, 0xD5F2);
			public static BA lut_2xNTRowStartLo                  = new BA(0x0F, 0xD5E2);
			public static BA PlayDoorSFX                         = new BA(0x0F, 0xCF1E);
			public static BA SMMove_AltarEffect                  = new BA(0x0F, 0xCE40);
			public static BA SMMove_OK                           = new BA(0x0F, 0xCE4F);
			public static BA SMMove_HaveSpecialItem              = new BA(0x0F, 0xCE08);
			public static BA SMMove_NoSpecialItem                = new BA(0x0F, 0xCDED);
			public static BA SMMove_AirOrb                       = new BA(0x0F, 0xCE36);
			public static BA SMMove_WaterOrb                     = new BA(0x0F, 0xCE2A);
			public static BA SMMove_FireOrb                      = new BA(0x0F, 0xCE1E);
			public static BA SMMove_EarthOrb                     = new BA(0x0F, 0xCE12);
			public static BA SMMove_UseLute                      = new BA(0x0F, 0xCE10);
			public static BA SMMove_UseRod                       = new BA(0x0F, 0xCE0E);
			public static BA SMMove_4Orbs                        = new BA(0x0F, 0xCDFA);
			public static BA SMMove_Cube                         = new BA(0x0F, 0xCDF3);
			public static BA SMMove_Crown                        = new BA(0x0F, 0xCDE6);
			public static BA SMMove_Dmg                          = new BA(0x0F, 0xCDE4);
			public static BA SMMove_Battle                       = new BA(0x0F, 0xCDC3);
			public static BA SMMove_Treasure                     = new BA(0x0F, 0xCDC1);
			public static BA SMMove_CloseRoom                    = new BA(0x0F, 0xCE44);
			public static BA SMMove_Door                         = new BA(0x0F, 0xCE53);
			public static BA SMMove_Norm                         = new BA(0x0F, 0xCE51);
			public static BA SMMove_Up                           = new BA(0x0F, 0xCD64);
			public static BA SMMove_Down                         = new BA(0x0F, 0xCD29);
			public static BA SMMove_Left                         = new BA(0x0F, 0xCCEB);
			public static BA SMMove_Right                        = new BA(0x0F, 0xCCBF);
			public static BA SM_MovePlayer                       = new BA(0x0F, 0xCD1B);
			public static BA RedrawDoor                          = new BA(0x0F, 0xCEBB);
			public static BA Copy256                             = new BA(0x0F, 0xCC74);
			public static BA LoadSMTilesetData                   = new BA(0x0F, 0xCC08);
			public static BA OpenTreasureChest                   = new BA(0x0F, 0xDD78);
			public static BA lut_SMMoveJmpTbl                    = new BA(0x0F, 0xCDA1);
			public static BA GetSMTileProperties                 = new BA(0x0F, 0xCBBE);
			public static BA IsObjectInPath                      = new BA(0x0F, 0xCAA2);
			public static BA CanPlayerMoveSM                     = new BA(0x0F, 0xCA76);
			public static BA ShowDialogueBox                     = new BA(0x0F, 0xD602);
			public static BA SetSMScroll                         = new BA(0x0F, 0xCCA1);
			public static BA DrawDialogueBox                     = new BA(0x0F, 0xD4B1);
			public static BA TalkToSMTile                        = new BA(0x0F, 0xCBE2);
			public static BA DrawMapObjectsNoUpdate              = new BA(0x0F, 0xE4F6);
			public static BA CanTalkToMapObject                  = new BA(0x0F, 0xCB25);
			public static BA GetSMTargetCoords                   = new BA(0x0F, 0xCB61);
			public static BA LoadEpilogueSceneGFX                = new BA(0x0F, 0xE89C);
			public static BA ReenterStandardMap                  = new BA(0x0F, 0xCF3A);
			public static BA GetSMTilePropNow                    = new BA(0x0F, 0xCB94);
			public static BA DrawSMSprites                       = new BA(0x0F, 0xE40F);
			public static BA ProcessSMInput                      = new BA(0x0F, 0xC9C4);
			public static BA DoAltarEffect                       = new BA(0x0F, 0xDA4E);
			public static BA StandardMapMovement                 = new BA(0x0F, 0xCC80);
			public static BA StandardMapLoop                     = new BA(0x0F, 0xC8B6);
			public static BA EnterStandardMap                    = new BA(0x0F, 0xCF2E);
			public static BA AssignMapTileDamage                 = new BA(0x0F, 0xC861);
			public static BA MapTileDamage                       = new BA(0x0F, 0xC7DE);
			public static BA DrawMapPalette                      = new BA(0x0F, 0xD862);
			public static BA DrawFullMap                         = new BA(0x0F, 0xCFE7);
			public static BA LoadMapPalettes                     = new BA(0x0F, 0xD8AB);
			public static BA LoadOWCHR                           = new BA(0x0F, 0xE920);
			public static BA AnimateAirshipLanding               = new BA(0x0F, 0xE1C2);
			public static BA DockShip                            = new BA(0x0F, 0xC632);
			public static BA Board_Fail                          = new BA(0x0F, 0xC5E4);
			public static BA lut_FormationWeight                 = new BA(0x0F, 0xC58C);
			public static BA GetBattleFormation                  = new BA(0x0F, 0xC54A);
			public static BA BattleStepRNG                       = new BA(0x0F, 0xC571);
			public static BA OWMove_Up                           = new BA(0x0F, 0xC406);
			public static BA OWMove_Down                         = new BA(0x0F, 0xC3D2);
			public static BA OWMove_Left                         = new BA(0x0F, 0xC396);
			public static BA DoMapDrawJob                        = new BA(0x0F, 0xD0E9);
			public static BA OWMove_Right                        = new BA(0x0F, 0xC36C);
			public static BA SetOWScroll                         = new BA(0x0F, 0xC34B);
			public static BA MapPoisonDamage                     = new BA(0x0F, 0xC7FB);
			public static BA OW_MovePlayer                       = new BA(0x0F, 0xC3C4);
			public static BA SetOWScroll_PPUOn                   = new BA(0x0F, 0xC346);
			public static BA LoadOWTilesetData                   = new BA(0x0F, 0xC30F);
			public static BA UnboardBoat                         = new BA(0x0F, 0xC5CC);
			public static BA UnboardBoat_Abs                     = new BA(0x0F, 0xC5D2);
			public static BA IsOnCanal                           = new BA(0x0F, 0xC666);
			public static BA LandAirship                         = new BA(0x0F, 0xC6B8);
			public static BA StartMapMove                        = new BA(0x0F, 0xD023);
			public static BA BoardShip                           = new BA(0x0F, 0xC609);
			public static BA BoardCanoe                          = new BA(0x0F, 0xC5E6);
			public static BA IsOnBridge                          = new BA(0x0F, 0xC64D);
			public static BA OWCanMove                           = new BA(0x0F, 0xC47D);
			public static BA MinigameReward                      = new BA(0x0F, 0xC8A4);
			public static BA AnimateAirshipTakeoff               = new BA(0x0F, 0xE1A8);
			public static BA FlyAirship                          = new BA(0x0F, 0xC215);
			public static BA DoStandardMap                       = new BA(0x0F, 0xC8B3);
			public static BA ScreenWipe_Close                    = new BA(0x0F, 0xD701);
			public static BA EnterBattle_L                       = new BA(0x0F, 0xF200);
			public static BA LoadBattleCHRPal                    = new BA(0x0F, 0xE900);
			public static BA BattleTransition                    = new BA(0x0F, 0xD8CD);
			public static BA EnterOW_PalCyc                      = new BA(0x0F, 0xC762);
			public static BA LoadBridgeSceneGFX                  = new BA(0x0F, 0xE8CB);
			public static BA CyclePalettes                       = new BA(0x0F, 0xD946);
			public static BA DrawOWSprites                       = new BA(0x0F, 0xE225);
			public static BA ProcessOWInput                      = new BA(0x0F, 0xC23C);
			public static BA DoOWTransitions                     = new BA(0x0F, 0xC140);
			public static BA PrepAttributePos                    = new BA(0x0F, 0xD401);
			public static BA CallMusicPlay_NoSwap                = new BA(0x0F, 0xC681);
			public static BA OverworldMovement                   = new BA(0x0F, 0xC335);
			public static BA GetOWTile                           = new BA(0x0F, 0xC696);
			public static BA EnterOverworldLoop                  = new BA(0x0F, 0xC0D1);
			public static BA ScreenWipe_Open                     = new BA(0x0F, 0xD6DC);
			public static BA PrepOverworld                       = new BA(0x0F, 0xC6FD);
			public static BA ClearZeroPage                       = new BA(0x0F, 0xC454);
			public static BA NewGame_LoadStartingStats           = new BA(0x0F, 0xC76D);
			public static BA VerifyChecksum                      = new BA(0x0F, 0xC888);
			public static BA SwapPRG_L                           = new BA(0x0F, 0xFE03);
			public static BA DisableAPU                          = new BA(0x0F, 0xC469);
			public static BA GameStart                           = new BA(0x0F, 0xC012);
			public static BA ClearBattleMessageBuffer_L          = new BA(0x0F, 0xF20C);
			public static BA BattleCrossPageJump_L               = new BA(0x0F, 0xF209);
			public static BA DrawRosterBox_L                     = new BA(0x0F, 0xF212);
			public static BA DrawCommandBox_L                    = new BA(0x0F, 0xF215);
			public static BA UndrawNBattleBlocks_L               = new BA(0x0F, 0xF20F);
			public static BA DrawDrinkBox_L                      = new BA(0x0F, 0xF224);
			public static BA DrawBattleItemBox_L                 = new BA(0x0F, 0xF221);
			public static BA DrawCombatBox_L                     = new BA(0x0F, 0xF218);
			public static BA CallMinimapDecompress               = new BA(0x0F, 0xFFC0);
			public static BA Battle_ReadPPUData_L                = new BA(0x0F, 0xF206);
			public static BA Battle_WritePPUData_L               = new BA(0x0F, 0xF203);
			public static BA BattleWaitForVBlank_L               = new BA(0x0F, 0xF21E);
			public static BA BattleRNG_L                         = new BA(0x0F, 0xF227);
			public static BA DrawBattleMagicBox_L                = new BA(0x0F, 0xF21B);
			public static BA BattleScreenShake_L                 = new BA(0x0F, 0xF22A);
			public static BA FormatBattleString_L                = new BA(0x0F, 0xF22D);
			public static BA SwapBtlTmpBytes_L                   = new BA(0x0F, 0xF230);
			public static BA lut_RNG                             = new BA(0x0F, 0xF100);
			public static BA LoadPrice                           = new BA(0x0F, 0xECB9);
			public static BA LoadMenuCHRPal                      = new BA(0x0F, 0xE906);
			public static BA DrawBox                             = new BA(0x0F, 0xE063);
			public static BA WaitForVBlank_L                     = new BA(0x0F, 0xFE00);
			public static BA DrawCursor                          = new BA(0x0F, 0xEC95);
			public static BA DrawOBSprite                        = new BA(0x0F, 0xEBFD);
			public static BA LoadNewGameCHRPal                   = new BA(0x0F, 0xE8FA);
			public static BA lutClassBatSprPalette               = new BA(0x0F, 0xECA4);
			public static BA DrawSimple2x3Sprite                 = new BA(0x0F, 0xEC24);
			public static BA LoadShopCHRPal                      = new BA(0x0F, 0xE90C);
			public static BA UnadjustEquipStats                  = new BA(0x0F, 0xED92);
			public static BA SortEquipmentList                   = new BA(0x0F, 0xEFFC);
			public static BA ReadjustEquipStats                  = new BA(0x0F, 0xEE1B);
			public static BA EraseBox                            = new BA(0x0F, 0xE146);
			public static BA FadeOutBatSprPalettes               = new BA(0x0F, 0xFF90);
			public static BA FadeInBatSprPalettes                = new BA(0x0F, 0xFFA8);
			public static BA DrawItemBox                         = new BA(0x0F, 0xEF18);
			public static BA DrawEquipMenuStrings                = new BA(0x0F, 0xECDA);
			public static BA DrawComplexString_L                 = new BA(0x0F, 0xC003);
			public static BA CallMusicPlay_L                     = new BA(0x0F, 0xC009);
			public static BA DrawPalette_L                       = new BA(0x0F, 0xC00F);
			public static BA UpdateJoy_L                         = new BA(0x0F, 0xC00C);
			public static BA DrawBox_L                           = new BA(0x0F, 0xC006);
			public static BA UpdateJoy                           = new BA(0x0F, 0xD7C2);
			public static BA CallMusicPlay                       = new BA(0x0F, 0xC689);
			public static BA FindEmptyWeaponSlot                 = new BA(0x0F, 0xDD34);
			public static BA DrawPalette                         = new BA(0x0F, 0xD850);
			public static BA ClearOAM                            = new BA(0x0F, 0xC43C);
			public static BA DrawComplexString                   = new BA(0x0F, 0xDE36);
			public static BA AddGPToParty                        = new BA(0x0F, 0xDDEA);
			public static BA DrawImageRect                       = new BA(0x0F, 0xDCBC);
