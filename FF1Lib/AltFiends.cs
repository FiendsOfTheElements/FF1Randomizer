	...
	public partial class FF1Rom
	{
		...
		public void AlternativeFiends(EnemyScripts enemyScripts, MT19337 rng, Flags flags)
		{
			...
			new AlternateFiends {
					...
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.FIR3, (byte)SpellByte.RUSE, (byte)SpellByte.NUKE, (byte)SpellByte.FAST, (byte)SpellByte.FIR3, (byte)SpellByte.STOP, (byte)SpellByte.MUTE, (byte)SpellByte.FIR3 },
					SkillChance2 = 0x00,
					Skills2 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
				},
			new AlternateFiends {
					...
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.FIR3, (byte)SpellByte.ICE3, (byte)SpellByte.LIT3, (byte)SpellByte.STOP, (byte)SpellByte.LOK2, (byte)SpellByte.ZAP, (byte)SpellByte.CUR4, (byte)SpellByte.RUSE },
					SkillChance2 = 0x40,
