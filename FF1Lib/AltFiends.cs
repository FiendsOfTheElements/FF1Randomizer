	...
	public partial class FF1Rom
	{
		...
		public void AlternativeFiends(EnemyScripts enemyScripts, MT19337 rng, Flags flags)
		{
			...
			new AlternateFiends {
					...
					Skills1 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.RUSE, (byte)SpellByte.FOG2, (byte)SpellByte.CUR4, (byte)SpellByte.SLO2, (byte)SpellByte.FADE, (byte)SpellByte.WALL, (byte)SpellByte.BANE, (byte)SpellByte.RUSE },
					SkillChance2 = 0x00,
					Skills2 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
				},
			new AlternateFiends {
					...
					FiendPool = FiendPool.FinalFantasy4,
					SpellChance1 = 0x40,
					Spells1 = new List<byte> { (byte)SpellByte.FIR2, (byte)SpellByte.STUN, (byte)SpellByte.RUSE, (byte)SpellByte.FIR2, (byte)SpellByte.BRAK, (byte)SpellByte.FIR2, (byte)SpellByte.STUN, (byte)SpellByte.BRAK },
					SkillChance1 = 0x00,
					Skills1 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
					SpellChance2 = 0x00,
					Spells2 = new List<byte> { (byte)SpellByte.NONE, (byte)SpellByte.NONE, (byte)SpellByte.NONE, (byte)SpellByte.NONE, (byte)SpellByte.NONE, (byte)SpellByte.NONE, (byte)SpellByte.NONE, (byte)SpellByte.NONE },
			...
			new AlternateFiends {
					...
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.FADE, (byte)SpellByte.FAST, (byte)SpellByte.SLO2, (byte)SpellByte.RUSE, (byte)SpellByte.RUB, (byte)SpellByte.TMPR, (byte)SpellByte.CUR3, (byte)SpellByte.XFER },
					SkillChance2 = 0x40,
			...
			new AlternateFiends {
					...
					Skills1 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.FAST, (byte)SpellByte.CUR3, (byte)SpellByte.RUSE, (byte)SpellByte.WALL, (byte)SpellByte.FOG2, (byte)SpellByte.SABR, (byte)SpellByte.SLOW, (byte)SpellByte.CUR3 },
					SkillChance2 = 0x00,
					Skills2 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
				},
			new AlternateFiends {
			...
			new AlternateFiends {
					...
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.FIR3, (byte)SpellByte.RUSE, (byte)SpellByte.FIR3, (byte)SpellByte.FIR3, (byte)SpellByte.SABR, (byte)SpellByte.HEL3, (byte)SpellByte.FIR3, (byte)SpellByte.FIR3 },
					SkillChance2 = 0x40,
			...
			new AlternateFiends {
					...
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.FIR3, (byte)SpellByte.ICE3, (byte)SpellByte.CUR4, (byte)SpellByte.ICE3, (byte)SpellByte.RUSE, (byte)SpellByte.HEL3, (byte)SpellByte.NUKE, (byte)SpellByte.LIT3 },
					SkillChance2 = 0x00,
					Skills2 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
				},
			new AlternateFiends {
					...
					Skills1 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.FIR3, (byte)SpellByte.SLO2, (byte)SpellByte.LIT3, (byte)SpellByte.WALL, (byte)SpellByte.ICE3, (byte)SpellByte.RUSE, (byte)SpellByte.XXXX, (byte)SpellByte.BANE },
					SkillChance2 = 0x00,
					Skills2 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
				},
		new AlternateFiends {
		...
		new AlternateFiends {
					...
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.NUKE, (byte)SpellByte.XXXX, (byte)SpellByte.LOK2, (byte)SpellByte.ICE3, (byte)SpellByte.CUR3, (byte)SpellByte.FAST, (byte)SpellByte.RUSE, (byte)SpellByte.ICE3 },
					SkillChance2 = 0x40,
		...
		new AlternateFiends {
					...
					Skills1 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.RUSE, (byte)SpellByte.FADE, (byte)SpellByte.CUR3, (byte)SpellByte.LIT3, (byte)SpellByte.XXXX, (byte)SpellByte.STOP, (byte)SpellByte.INVS, (byte)SpellByte.NUKE },
					SkillChance2 = 0x00,
					Skills2 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
				},
		new AlternateFiends {
					...
					FiendPool = FiendPool.FinalFantasy4,
					SpellChance1 = 0x40,
					Spells1 = new List<byte> { (byte)SpellByte.RUSE, (byte)SpellByte.ZAP, (byte)SpellByte.ICE2, (byte)SpellByte.ICE2, (byte)SpellByte.LIT2, (byte)SpellByte.FAST, (byte)SpellByte.SLOW, (byte)SpellByte.LIT2 },
					SkillChance1 = 0x40,
					Skills1 = new List<byte> { (byte)EnemySkills.Cremate, (byte)EnemySkills.Frost, (byte)EnemySkills.Gaze, (byte)EnemySkills.Trance },
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.QAKE, (byte)SpellByte.FADE, (byte)SpellByte.CUR4, (byte)SpellByte.FAST, (byte)SpellByte.RUSE, (byte)SpellByte.SABR, (byte)SpellByte.NUKE, (byte)SpellByte.XXXX },
					SkillChance2 = 0x40,
		...
		new AlternateFiends {
				...
				new AlternateFiends {
					...
					FiendPool = FiendPool.FinalFantasy4,
					SpellChance1 = 0x40,
					Spells1 = new List<byte> { (byte)SpellByte.RUSE, (byte)SpellByte.FIR2, (byte)SpellByte.FIR2, (byte)SpellByte.HEL2, (byte)SpellByte.MUTE, (byte)SpellByte.LIT2, (byte)SpellByte.LIT2, (byte)SpellByte.SLOW },
					SkillChance1 = 0x40,
			...
			var FF6AltFiendsList = new List<AlternateFiends>
			{
					...
					Skills1 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.CUR3, (byte)SpellByte.FAST, (byte)SpellByte.FOG2, (byte)SpellByte.RUSE, (byte)SpellByte.TMPR, (byte)SpellByte.HEL3, (byte)SpellByte.CUR3, (byte)SpellByte.FOG2 },
					SkillChance2 = 0x00,
					Skills2 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
					},
			...
			new AlternateFiends {
					...
					Skills1 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.FADE, (byte)SpellByte.XFER, (byte)SpellByte.FAST, (byte)SpellByte.XFER, (byte)SpellByte.FADE, (byte)SpellByte.SLO2, (byte)SpellByte.MUTE, (byte)SpellByte.RUSE },
					SkillChance2 = 0x40,
			...
			new AlternateFiends {
					...
					Skills1 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.ICE3, (byte)SpellByte.FAST, (byte)SpellByte.FADE, (byte)SpellByte.SLO2, (byte)SpellByte.ICE3, (byte)SpellByte.RUSE, (byte)SpellByte.FADE, (byte)SpellByte.FAST },
					SkillChance2 = 0x40,
			...
			new AlternateFiends {
					...
					Skills1 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.NUKE, (byte)SpellByte.XXXX, (byte)SpellByte.MUTE, (byte)SpellByte.ICE3, (byte)SpellByte.SLO2, (byte)SpellByte.RUSE, (byte)SpellByte.LIT3, (byte)SpellByte.BRAK },
					SkillChance2 = 0x00,
					Skills2 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
					},
			...
			new AlternateFiends {
					...
					FiendPool = FiendPool.FinalFantasy2,
					SpellChance1 = 0x40,
					Spells1 = new List<byte> { (byte)SpellByte.ICE, (byte)SpellByte.ICE2, (byte)SpellByte.LIT2, (byte)SpellByte.RUSE, (byte)SpellByte.ICE2, (byte)SpellByte.SLOW, (byte)SpellByte.LOCK, (byte)SpellByte.LIT2 },
					SkillChance1 = 0x40,
			...
			new AlternateFiends {
					...
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.FAST, (byte)SpellByte.ICE3, (byte)SpellByte.BRAK, (byte)SpellByte.LIT3, (byte)SpellByte.WALL, (byte)SpellByte.FIR3, (byte)SpellByte.RUSE, (byte)SpellByte.LIT3 },
					SkillChance2 = 0x40,
			...
			var FF1BonusFiendsList = new List<AlternateFiends>
			{
					...
					Skills1 = new List<byte> { (byte)EnemySkills.Ink, (byte)EnemySkills.Ink, (byte)EnemySkills.Ink, (byte)EnemySkills.Ink },
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.LIT3, (byte)SpellByte.DARK, (byte)SpellByte.RUSE, (byte)SpellByte.XXXX, (byte)SpellByte.LIT3, (byte)SpellByte.XFER, (byte)SpellByte.LOCK, (byte)SpellByte.BANE },
					SkillChance2 = 0x40,
					...
					Skills1 = new List<byte> { (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None, (byte)EnemySkills.None },
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.SABR, (byte)SpellByte.RUSE, (byte)SpellByte.LOK2, (byte)SpellByte.FADE, (byte)SpellByte.SABR, (byte)SpellByte.RUSE, (byte)SpellByte.LOK2, (byte)SpellByte.CUR4 },
					SkillChance2 = 0x40,
					...
					SpellChance2 = 0x40,
					Spells2 = new List<byte> { (byte)SpellByte.HOLD, (byte)SpellByte.STOP, (byte)SpellByte.RUSE, (byte)SpellByte.FOG, (byte)SpellByte.XFER, (byte)SpellByte.STOP, (byte)SpellByte.QAKE, (byte)SpellByte.SLP2 },
					SkillChance2 = 0x40,
