	...
	public partial class FF1Rom
	{
		...
		public class TalkRoutines
		{
			...
			public TalkRoutines()
			{
				...
				_talkroutines.Add(Blob.FromHex("60")); // Talk_None
				_talkroutines.Add(Blob.FromHex("A57160")); // Talk_norm
				_talkroutines.Add(Blob.FromHex("A470209190B003A57160A57260")); // Talk_ifvis
				_talkroutines.Add(Blob.FromHex("A5706920A8B90060F003A57160A57260")); // Talk_ifitem
				_talkroutines.Add(Blob.FromHex("A012209190B008AD2160D003A57160A57260")); // Talk_Invis
				_talkroutines.Add(Blob.FromHex("A470207990B003A57160A57260")); // Talk_ifevent
				_talkroutines.Add(Blob.FromHex("A0122091909008AD0860D003A57160A57260")); // Talk_GoBridge
				_talkroutines.Add(Blob.FromHex("AD32602D33602D34602D3160F003A57160A57260")); // Talk_4Orb
				_talkroutines.Add(Blob.FromHex("AD2560F008AD2660D003A57160A57260")); // Talk_ifkeytnt
				_talkroutines.Add(Blob.FromHex("A00C209190B008AD3160D003A57160A57260")); // Talk_ifearthvamp
				_talkroutines.Add(Blob.FromHex("AD3160F008AD3260D003A57160A57260")); // Talk_ifearthfire
				_talkroutines.Add(Blob.FromHex("A476209690A47320A490A57160")); // Talk_Replace
				_talkroutines.Add(Blob.FromHex("A476209690A57160")); // Talk_CoOGuy
				_talkroutines.Add(Blob.FromHex("A571203D96A5752020B1A476207F902073922018964C439660")); // Talk_fight
				_talkroutines.Add(Blob.FromHex("AD32602D33602D34602D3160F00CA0CA209690E67DE67DA57160A57260")); // Talk_BlackOrb
				_talkroutines.Add(Blob.FromHex("A476207F90209690A01220A490A93F20CC90A57160")); // Talk_Princess1
				_talkroutines.Add(Blob.FromHex("AD3060D003A57160A476209690A57260")); // Talk_SubEng
				_talkroutines.Add(Blob.FromHex("AD2960D003A57160CE2960A476209690A572E67D60")); // Talk_Titan
				...
				_talkroutines.Add(Blob.FromHex("A00E2079909003A57360AD2D60D003A57160CE2D60207F9020AE95E67DA57260")); // Talk_Bahamut
				_talkroutines.Add(Blob.FromHex("A476207990B012A674BD2060F00EDE2060207F90E67DA57260A57160A57060")); // Talk_ElfDocUnne
				_talkroutines.Add(Blob.FromHex("A476207990B01BA474F0052079909015A573F0111820109FB00DA476207F90A57260A57160A57060")); // Talk_GiveItemOnFlag
				_talkroutines.Add(Blob.FromHex("A476207990B01EA674BD2060F01AA573F0161820109FB012A674DE2060A476207F90A57260A57160A57060")); // Talk_TradeItems
				_talkroutines.Add(Blob.FromHex("A476207990B01BA674F005BD2060F015A573F0111820109FB00DA476207F90A57260A57160A57060")); // Talk_GiveItemOnItem
		...
		public void TransferTalkRoutines(Flags flags)
		{
			...
			PutInBank(newTalkRoutinesBank, 0x901B, Blob.FromHex("BD006F8576200CB1A57618A00084150A26151865769002E6150A261569008514A9BA651585158612A900AAA8B1149570C8E8E006D0F6A612A5760AA8900DB900818516B9018185176C1600B900808516B9018085176C1600"));
			Data[0x7C9F7] = 0x1B;
			...
			PutInBank(newTalkRoutinesBank, 0xB0D0, Blob.FromHex("B900624A4A4A4A60EAEAB90062090899006260EAEAC922F022C923F01EC976F01AC991F016C992F012C9ADF00EC9CAF00A20DAB0ACC060C88CC06060ADC160C9FFF00BA47620D0B0B0049820E5B060"));
