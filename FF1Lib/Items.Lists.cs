...
namespace FF1Lib
{
    ...
    {
        public static readonly IReadOnlyCollection<byte> Tier1Requirements =
            new List<byte> {
            Lute, Key, EarthOrb, FireOrb, WaterOrb, AirOrb, 
            Canoe, Floater, Rod, Oxyale, Chime, Cube
        };
        public static readonly IReadOnlyCollection<byte> Tier2Requirements =
            new List<byte> {
            Tnt, Herb, Crystal, Crown, Slab, Bottle, Ruby
        };
        public static readonly IReadOnlyCollection<byte> NiceOptionals1 =
            new List<byte> {
            Tail, Adamant, Masamune, Xcalber, Ribbon
        };
        public static readonly IReadOnlyCollection<byte> NiceOptionals2 =
            new List<byte> {
            ProRing, ProCape, Opal, DragonArmor, Katana, WhiteShirt, BlackShirt,
            PowerGauntlets, ZeusGauntlets, Defense
        };
        public static readonly IReadOnlyCollection<byte> NiceOptionals3 =
            new List<byte> {
            HealHelm, AegisShield, BaneSword, ThorHammer, MageRod, WizardRod, 
            LightAxe, HealRod, Gold65000
        };

        public static readonly IReadOnlyCollection<byte> AllWeapons =
            new List<byte> {
        ...
        public static readonly IReadOnlyCollection<byte> AllArmor =
            new List<byte> {
        ...
        public static readonly IReadOnlyCollection<byte> AllConsumables =
            new List<byte> { Tent, Cabin, House, Heal, Pure, Soft };

        public static readonly IReadOnlyCollection<byte> AllQuestItems =
            new List<byte> {
            Lute, Crown, Crystal, Herb, Key, Tnt, Adamant, Slab, Ruby, Rod,
            Floater, Chime, Tail, Cube, Bottle, Oxyale, Canoe
        };

        public static readonly IReadOnlyCollection<byte> AllOrbs =
            new List<byte> {
            EarthOrb, FireOrb, WaterOrb, AirOrb
        };

		public static readonly IReadOnlyCollection<byte> AllGoldTreasure =
			new List<byte> {
