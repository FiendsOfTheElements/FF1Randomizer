...
namespace FF1Lib
{
    ...
    {
        public static readonly ReadOnlyCollection<ItemLocation> Unused =
       new List<ItemLocation>{ Unused2, Unused3, Unused4, Unused5,
            Unused6, Unused7, Unused8, Unused9, Unused10, Unused11,
            Unused12, Unused13, Unused14, Unused15 }.AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> Coneria =
            new List<ItemLocation> { Coneria1, Coneria2, ConeriaMajor, Coneria4, Coneria5, Coneria6 }
            .AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> TempleOfFiends =
            new List<ItemLocation>{ TempleOfFiendsTopLeft1, TempleOfFiendsTopLeft2, TempleOfFiendsBottomLeft,
            TempleOfFiendsBottomRight, TempleOfFiendsTopRight1, TempleOfFiendsTopRight2}.AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> MatoyasCave =
            new List<ItemLocation> { MatoyasCave1, MatoyasCave2, MatoyasCave3 }
            .AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> Elfland =
            new List<ItemLocation> { Elfland1, Elfland2, Elfland3, Elfland4 }.AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> MarshCave =
            ...
            MarshCave10, MarshCave11, MarshCave12, MarshCave13 }.AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> NorthwestCastle =
            new List<ItemLocation> { NorthwestCastle1, NorthwestCastle2, NorthwestCastle3 }
            .AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> DwarfCave =
            new List<ItemLocation>{ DwarfCave1, DwarfCave2, DwarfCave3, DwarfCave4,
            DwarfCave5, DwarfCave6, DwarfCave7, DwarfCave8, DwarfCave9,
            DwarfCave10 }.AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> EarthCave =
            ...
            .AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> TitansTunnel =
            new List<ItemLocation> { TitansTunnel1, TitansTunnel2, TitansTunnel3, TitansTunnel4 }
            .AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> GurguVolcano =
            ...
            .AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> IceCave =
            ...
            IceCave15, IceCave16 }.AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> Ordeals =
            new List<ItemLocation> { Ordeals1, Ordeals2, Ordeals3, Ordeals4, Ordeals5,
            Ordeals6, Ordeals7, Ordeals8, OrdealsMajor }.AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> Cardia =
            new List<ItemLocation> { Cardia1, Cardia2, Cardia3, Cardia4, Cardia5,
            Cardia6, Cardia7, Cardia8, Cardia9, Cardia10, Cardia11,
            Cardia12, Cardia13 }.AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> SeaShrine =
            ...
            SeaShrine30, SeaShrine31, SeaShrineMajor }.AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> Waterfall =
            new List<ItemLocation> { Waterfall1, Waterfall2, Waterfall3, Waterfall4,
            Waterfall5, Waterfall6 }.AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> MirageTower =
            ...
            MirageTower15, MirageTower16, MirageTower17, MirageTower18 }.AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> SkyPalace =
            ...
            .AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> ToFR =
            new List<ItemLocation> { ToFRevisitedMajor, ToFRevisited2, ToFRevisited3,
            ToFRevisited4, ToFRevisited5, ToFRevisited6, ToFRevisited7}.AsReadOnly();
        public static readonly ReadOnlyCollection<ItemLocation> AllTreasures =
        ...
        public static readonly ReadOnlyCollection<ItemLocation> AllNPCItemLocations =
            new List<ItemLocation> {
            KingConeria, Princess, Matoya, Bikke, ElfPrince, Astos, Nerrick, Sarda, CanoeSage, CubeBot, Fairy, Lefein
        }.AsReadOnly();

        public static readonly ReadOnlyCollection<ItemLocation> AllShopItemLocations =
            new List<ItemLocation> {
            CaravanItemShop1
        }.AsReadOnly();

        public static readonly ReadOnlyCollection<ItemLocation> AllNonTreasureItemLocations =
            AllNPCItemLocations.Concat(AllShopItemLocations).ToList().AsReadOnly();

        public static readonly ReadOnlyCollection<ItemLocation> AllQuestItemLocations =
            AllTreasures.Concat(AllNonTreasureItemLocations).Where(x => !x.IsUnused).ToList().AsReadOnly();
