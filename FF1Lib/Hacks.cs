...
namespace FF1Lib
{
	public partial class FF1Rom : NesRom
	{
		...
		public void PubReplaceClinic(MT19337 rng)
		{
			...
			pub_lut.Shuffle(rng);
			pub_lut.Insert(3, 0x0);
			Put(0x38066, Blob.FromHex("9D8A9F8E9B97")); // Replaces "CLINIC" with "TAVERN"
														// EnterClinic
			PutInBank(0x0E, 0xA5A1, Blob.FromHex(""));
			...
			//ReviveorBuy routine
			PutInBank(0x0E, 0x9D1B, Blob.FromHex("A903203BAAA911853EA99D853F2032AAA9028D62004C07A9"));

			// Buy Revive text options
			PutInBank(0x0E, 0x9D11, Blob.FromHex("8BB8BC019BA8B9AC3200"));

			// New routine to level up replaced character and zero some stuff, needs new level up stuff in bank 1B
			PutInBank(0x0E, 0x9D33, Blob.FromHex("A99D48A94A48A98748A9A9488A182A2A2A8510A91B4C03FEA9008D24008D25009D01618D012060"));
