...
namespace FF1Lib
{
	...
	public class PlacementContext
	{
		...
		private List<Item> KeyItems = new() { Item.Lute, Item.Bridge, Item.Ship, Item.Adamant, Item.Crown, Item.Crystal, Item.Herb, Item.Key, Item.Tnt, Item.Canal, Item.Ruby, Item.Rod, Item.Canoe, Item.Floater, Item.Tail, Item.Bottle, Item.Oxyale, Item.Cube, Item.Slab, Item.Chime };
