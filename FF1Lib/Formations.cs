...
namespace FF1Lib
{
	public static class FormationLists
	{
		...
		//public static List<byte> IncludeWarmechEncounter = AllRandomEncounters.Select(value => (byte)value).Concat(WarMechEncounter).ToList(); //I don't think this worked from testing
	...
	public class ZoneFormations
	{
		...
		public void ReplaceDomain(ZoneFormation newzoneformation, int to)
		{
			formations[to] = new ZoneFormation() { Index = to, Formations = newzoneformation.Formations };
		}
