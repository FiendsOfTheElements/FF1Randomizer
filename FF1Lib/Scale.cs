			...
			switch (flags.SleepModeDropDown)
			{
				...
				case SleepMode.WakeOnHit:
					...
					if (flags.AfterHits == true)
					{
						...
						PutInBank(0x0C, 0xA889, Blob.FromHex("AD6468D003EE6468A900A2C8205DAE8D6668C9C8F01CAD6468CD66689014AD896849FF2D73682088A9AD89680D73688D8968CE5A68F00B4CDDA7A9DF2D89688D8968"));
					}
					break;
