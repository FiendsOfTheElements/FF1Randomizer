...
namespace FF1Lib
{
	...
	public partial class FF1Rom : NesRom
	{
		...
		public void FixMute(Flags flags)
		{
			// Removes the manual get magic data ptr math and replaces it with function that does the same thing to free up space
			PutInBank(0x0C, 0xB363, Blob.FromHex("20119785988699EAEAEAEAEAEAEAEAEAEAEAEAEAEAEA"));
