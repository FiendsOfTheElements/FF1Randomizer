...
namespace FF1Lib
{
	public partial class FF1Rom : NesRom
	{
		...
		public const int FormationOffset = 0x2C000;
		public const int FormationSize = 8;
		public const int FormationCount = 128;

		public void ShuffleEnemyFormations(MT19337 rng)
		{
			//intra-zone shuffle, does not change which formations are in zomes.
			var oldFormations = Get(FormationOffset, FormationSize * FormationCount).Chunk(FormationSize);
			var newFormations = Get(FormationOffset, FormationSize * FormationCount).Chunk(FormationSize);
			...
			Put(FormationOffset, newFormations.SelectMany(formation => formation.ToBytes()).ToArray());
		}
