...
namespace FF1Lib
{
	...
	public class ExtConsumables
	{
		...
		{
			rom.PutInBank(0x0C, 0xA364, Blob.FromHex("9008BE9168A5884CBAA44A4A9012A688A9009DA368B99068BE9168A4884CB5B34A9005A5884CD8A34A90179848A488BEA768DE206368A8B99068BE9168A4884CC5B3A5882045A1A001B1828589"));
			if (flags.SleepModeDropDown != SleepMode.WakeOnHit)
			{
				rom.PutInBank(0x0C, 0xA3B1, Blob.FromHex("2920F005A5884C2FA4"));
			}
			rom.PutInBank(0x0C, 0xA3BA, Blob.FromHex("A5892910F005A5884C81A460A00488209993C000D0F84C3B93"));
		}
