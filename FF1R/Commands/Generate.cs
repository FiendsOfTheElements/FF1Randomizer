  ...
  class Generate
  {
    ...
    int OnExecute(IConsole console)
    {
      ...
      else if (!String.IsNullOrEmpty(Import))
      {
        ...
        {
          console.WriteLine("Ensure that you are using an import string");
          console.WriteLine("in a format as supplied by crim_bot or the");
          console.WriteLine("finalfantasyrandomizer.com web version.");
          return 1;
        }
      }
      else
