...
- Shared Desktop and Commandlin stuff: FFR.Common
...
#### Git Terms
 - commit: A discrete piece of history in the version contorl system
 ...
 - pull and push: transfering files from the repo to your local stuff or the other way around.
...
7. Now in your forked repo, clone it. Click on the "Code" button at the top of this page and select your relevent clone type (https or ssh) and copy that url. Then in your terminal/command line, navigate to the directory where you want the FFR directory to reside in, then type: `git clone <url you copied, without the angled brackets here>`
